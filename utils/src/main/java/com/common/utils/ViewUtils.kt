...
//    fun getAccentColor(context: Context): Int = getColorAttr(context, R.attr.colorAccent)
    ...
    private fun isTablet(resources: Resources): Boolean = resources.configuration.screenLayout and Configuration.SCREENLAYOUT_SIZE_MASK >= Configuration.SCREENLAYOUT_SIZE_LARGE
